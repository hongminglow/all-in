...
import { ArrowLeft, Wallet, History, TrendingUp, Clock } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-4 py-8 lg:grid-cols-3">
        <div className="space-y-6 lg:col-span-2">
          <Card className="border-white/20 bg-gradient-to-r from-purple-900/70 to-indigo-900/70 p-6 backdrop-blur-lg">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Clock className={`h-8 w-8 ${getTimerColor()}`} />
                <div>
                  <div className={`text-4xl ${getTimerColor()}`}>
                    {timeLeft}s
                  </div>
